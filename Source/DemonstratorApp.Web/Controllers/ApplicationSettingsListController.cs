...
using DemonstratorApp.UI.ViewModels.ApplicationSettingsList;
...
namespace DemonstratorApp.UI.Controllers.ApplicationSettingsList
{
    ...
    public class ApplicationSettingsListController : ControllerBase<ApplicationSettingsListViewModel, ApplicationSettingsListViewModelDTO>
    {
        ...
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DemonstratorApp.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>().AsQueryable();
            return __items;
        }
