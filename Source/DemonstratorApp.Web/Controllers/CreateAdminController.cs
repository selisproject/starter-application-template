...
using DemonstratorApp.UI.ViewModels.CreateAdmin;
...
namespace DemonstratorApp.UI.Controllers.CreateAdmin
{
    ...
    public class CreateAdminController : ControllerBase<CreateAdminViewModel, CreateAdminViewModelDTO>
    {
        ...
        public ActionResult ExecuteCreate()
        {
            ...
            zAppDev.DotNet.Framework.Identity.Model.ApplicationRole adminRole = new DemonstratorApp.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>((r) => r.Name == "Administrator")?.FirstOrDefault();
            if ((adminRole == null))
            {
        ...
        {
            ActionResult _result = null;
            if ((new DemonstratorApp.DAL.Repository().GetCount<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>((u) => u.Roles.Any((r) => r.Name == "Administrator")) > 0))
            {
