...
using DemonstratorApp.UI.ViewModels.ManageOperation;
...
namespace DemonstratorApp.UI.Controllers.ManageOperation
{
    ...
    public class ManageOperationController : ControllerBase<ManageOperationViewModel, ManageOperationViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditOperation(int? Id)
        {
            ...
            @model.ApplicationOperation =  new DemonstratorApp.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(Id);
        ...
        {
            ActionResult _result = null;
            new DemonstratorApp.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(@model.ApplicationOperation);
            _result = CloseForm();
            return _result;
        }
        #endregion
