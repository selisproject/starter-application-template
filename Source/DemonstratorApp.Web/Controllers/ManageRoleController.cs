...
using DemonstratorApp.UI.ViewModels.ManageRole;
...
namespace DemonstratorApp.UI.Controllers.ManageRole
{
    ...
    public class ManageRoleController : ControllerBase<ManageRoleViewModel, ManageRoleViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditRole(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationRole =  new DemonstratorApp.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(Id);
        ...
        {
            ActionResult _result = null;
            new DemonstratorApp.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DemonstratorApp.DAL.Repository().DeleteApplicationRole(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        #endregion
