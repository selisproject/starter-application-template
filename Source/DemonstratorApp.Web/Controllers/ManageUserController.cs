...
using DemonstratorApp.UI.ViewModels.ManageUser;
...
namespace DemonstratorApp.UI.Controllers.ManageUser
{
    ...
    public class ManageUserController : ControllerBase<ManageUserViewModel, ManageUserViewModelDTO>
    {
        ...
        public ActionResult ExecuteEditUser(string Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationUser =  new DemonstratorApp.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(Id);
        ...
        public ActionResult ExecuteSaveUser()
        {
            ...
            {
                new DemonstratorApp.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>(@model.ApplicationUser);
            }
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DemonstratorApp.DAL.Repository().DeleteApplicationUser(@model.ApplicationUser);
            _result = CloseForm();
            return _result;
        }
        #endregion
        ...
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DemonstratorApp.DAL.Repository().GetAsQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission>().AsQueryable();
            return __items;
        }
