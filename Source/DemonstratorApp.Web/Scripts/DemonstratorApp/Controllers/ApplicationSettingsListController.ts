...
interface Window { scope_ApplicationSettingsList: DemonstratorApp.Controllers.IApplicationSettingsListScope; }
...
model:
    DemonstratorApp.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._lightCast(window.scope_ApplicationSettingsList.model);
    ...
    constructor(private $scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom(window.viewDTO.Model);
