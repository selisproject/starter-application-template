...
interface Window { scope_ChangePassword: DemonstratorApp.Controllers.IChangePasswordScope; }
...
model:
    DemonstratorApp.ViewModels.ChangePassword.ChangePasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ChangePassword.ChangePasswordViewModel._lightCast(window.scope_ChangePassword.model);
    ...
    constructor(private $scope: IChangePasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ChangePassword.ChangePasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IChangePasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ChangePassword.ChangePasswordViewModel._initializeFrom(window.viewDTO.Model);
