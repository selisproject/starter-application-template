        ...
        var DashboardStatisticsController = (function () {
            function DashboardStatisticsController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DemonstratorApp.ViewModels.DashboardStatistics.DashboardStatisticsViewModel._initializeFrom($scope.model, context);
                };
            ...
            DashboardStatisticsController.prototype.init = function ($scope, $timeout) {
                ...
                $scope.events = {};
                $scope.expressions = {
                    ChartDataQualityXScaleMin: function () { return 0; },
                    ChartDataQualityXScaleMax: function () { return 100; },
                    ChartDataQualityXScaleStepSize: function () { return 25; },
                    ...
                    ChartYScaleMax: function () { return 1000; },
                    ChartYScaleStepSize: function () { return 100; }
                };
                // Dataset Handler
                $scope.datasets = {};
                // Controller actions
