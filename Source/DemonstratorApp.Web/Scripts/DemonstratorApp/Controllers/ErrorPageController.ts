...
interface Window { scope_ErrorPage: DemonstratorApp.Controllers.IErrorPageScope; }
...
model:
    DemonstratorApp.ViewModels.ErrorPage.ErrorPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ErrorPage.ErrorPageViewModel._lightCast(window.scope_ErrorPage.model);
    ...
    constructor(private $scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IErrorPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom(window.viewDTO.Model);
