...
interface Window { scope_ForgotPassword: DemonstratorApp.Controllers.IForgotPasswordScope; }
...
model:
    DemonstratorApp.ViewModels.ForgotPassword.ForgotPasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ForgotPassword.ForgotPasswordViewModel._lightCast(window.scope_ForgotPassword.model);
    ...
    constructor(private $scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom(window.viewDTO.Model);
