...
interface Window { scope_HomePage: DemonstratorApp.Controllers.IHomePageScope; }
...
model:
    DemonstratorApp.ViewModels.HomePage.HomePageViewModel;
...
class HomePageController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.HomePage.HomePageViewModel._lightCast(window.scope_HomePage.model);
    ...
    constructor(private $scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.HomePage.HomePageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IHomePageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.HomePage.HomePageViewModel._initializeFrom(window.viewDTO.Model);
