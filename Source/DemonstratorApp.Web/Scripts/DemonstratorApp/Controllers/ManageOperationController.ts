...
interface Window { scope_ManageOperation: DemonstratorApp.Controllers.IManageOperationScope; }
...
model:
    DemonstratorApp.ViewModels.ManageOperation.ManageOperationViewModel;
...
private timeoutDelayLockButton4Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ManageOperation.ManageOperationViewModel._lightCast(window.scope_ManageOperation.model);
    ...
    constructor(private $scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom(window.viewDTO.Model);
