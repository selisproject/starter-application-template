...
interface Window { scope_ManagePermission: DemonstratorApp.Controllers.IManagePermissionScope; }
...
model:
    DemonstratorApp.ViewModels.ManagePermission.ManagePermissionViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    constructor(private $scope: IManagePermissionScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ManagePermission.ManagePermissionViewModel._initializeFrom($scope.model, context);
