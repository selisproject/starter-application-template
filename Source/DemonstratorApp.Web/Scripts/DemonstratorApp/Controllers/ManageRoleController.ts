...
interface Window { scope_ManageRole: DemonstratorApp.Controllers.IManageRoleScope; }
...
model:
    DemonstratorApp.ViewModels.ManageRole.ManageRoleViewModel;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ManageRole.ManageRoleViewModel._lightCast(window.scope_ManageRole.model);
    ...
    constructor(private $scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom(window.viewDTO.Model);
