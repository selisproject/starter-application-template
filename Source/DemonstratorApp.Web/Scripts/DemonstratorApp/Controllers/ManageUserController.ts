...
interface Window { scope_ManageUser: DemonstratorApp.Controllers.IManageUserScope; }
...
model:
    DemonstratorApp.ViewModels.ManageUser.ManageUserViewModel;
...
private timeoutDelayLockExitBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.ManageUser.ManageUserViewModel._lightCast(window.scope_ManageUser.model);
    ...
    constructor(private $scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.ManageUser.ManageUserViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.ManageUser.ManageUserViewModel._initializeFrom(window.viewDTO.Model);
