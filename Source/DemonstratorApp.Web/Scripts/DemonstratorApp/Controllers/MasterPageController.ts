...
interface Window { scope_MasterPage: DemonstratorApp.Controllers.IMasterPageScope; }
...
private timeoutDelayLockMasterSignInMenuItemPressed:
    ...
    constructor(private $scope: IMasterPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.MasterPage.MasterPageViewModel._initializeFrom($scope.model, context);
