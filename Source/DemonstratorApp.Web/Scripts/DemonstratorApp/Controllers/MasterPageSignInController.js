        ...
        var MasterPageSignInController = (function () {
            function MasterPageSignInController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    //
                    DemonstratorApp.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._lightCast(window.scope_MasterPageSignIn.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DemonstratorApp.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._initializeFrom($scope.model, context);
                };
