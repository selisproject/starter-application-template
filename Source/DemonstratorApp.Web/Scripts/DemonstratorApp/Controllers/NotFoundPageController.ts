...
interface Window { scope_NotFoundPage: DemonstratorApp.Controllers.INotFoundPageScope; }
...
model:
    DemonstratorApp.ViewModels.NotFoundPage.NotFoundPageViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.NotFoundPage.NotFoundPageViewModel._lightCast(window.scope_NotFoundPage.model);
    ...
    constructor(private $scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom(window.viewDTO.Model);
