...
interface Window { scope_OperationsList: DemonstratorApp.Controllers.IOperationsListScope; }
...
model:
    DemonstratorApp.ViewModels.OperationsList.OperationsListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.OperationsList.OperationsListViewModel._lightCast(window.scope_OperationsList.model);
    ...
    constructor(private $scope: IOperationsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.OperationsList.OperationsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IOperationsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.OperationsList.OperationsListViewModel._initializeFrom(window.viewDTO.Model);
