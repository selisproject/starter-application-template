...
interface Window { scope_SignInPage: DemonstratorApp.Controllers.ISignInPageScope; }
...
model:
    DemonstratorApp.ViewModels.SignInPage.SignInPageViewModel;
...
private timeoutDelayLockButton2Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.SignInPage.SignInPageViewModel._lightCast(window.scope_SignInPage.model);
    ...
    constructor(private $scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.SignInPage.SignInPageViewModel._initializeFrom(window.viewDTO.Model);
