...
interface Window { scope_SignOutPage: DemonstratorApp.Controllers.ISignOutPageScope; }
...
model:
    DemonstratorApp.ViewModels.SignOutPage.SignOutPageViewModel;
...
class SignOutPageController {
    ...
    constructor(private $scope: ISignOutPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.SignOutPage.SignOutPageViewModel._initializeFrom($scope.model, context);
