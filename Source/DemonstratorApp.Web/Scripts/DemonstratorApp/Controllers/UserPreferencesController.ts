...
interface Window { scope_UserPreferences: DemonstratorApp.Controllers.IUserPreferencesScope; }
...
model:
    DemonstratorApp.ViewModels.UserPreferences.UserPreferencesViewModel;
...
private timeoutDelayLockCancelBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.UserPreferences.UserPreferencesViewModel._lightCast(window.scope_UserPreferences.model);
    ...
    constructor(private $scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom(window.viewDTO.Model);
