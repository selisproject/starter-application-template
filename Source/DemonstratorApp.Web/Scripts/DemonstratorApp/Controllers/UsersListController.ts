...
interface Window { scope_UsersList: DemonstratorApp.Controllers.IUsersListScope; }
...
model:
    DemonstratorApp.ViewModels.UsersList.UsersListViewModel;
...
private timeoutDelayLockEditClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DemonstratorApp.ViewModels.UsersList.UsersListViewModel._lightCast(window.scope_UsersList.model);
    ...
    constructor(private $scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DemonstratorApp.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DemonstratorApp.ViewModels.UsersList.UsersListViewModel._initializeFrom(window.viewDTO.Model);
