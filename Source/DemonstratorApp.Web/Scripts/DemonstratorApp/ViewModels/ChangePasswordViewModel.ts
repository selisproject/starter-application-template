...
namespace DemonstratorApp.ViewModels.ChangePassword {
export class ChangePasswordViewModel extends DemonstratorApp.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
