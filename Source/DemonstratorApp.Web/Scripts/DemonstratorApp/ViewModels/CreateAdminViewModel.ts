...
namespace DemonstratorApp.ViewModels.CreateAdmin {
export class CreateAdminViewModel extends DemonstratorApp.ViewModels.MasterPageSignIn.MasterPageSignInViewModel {
    public constructor() {
        super();
