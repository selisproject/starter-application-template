...
namespace DemonstratorApp.ViewModels.ForgotPassword {
export class ForgotPasswordViewModel extends DemonstratorApp.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
