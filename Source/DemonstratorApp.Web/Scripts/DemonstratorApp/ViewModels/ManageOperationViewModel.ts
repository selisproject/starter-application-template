...
namespace DemonstratorApp.ViewModels.ManageOperation {
export class ManageOperationViewModel extends DemonstratorApp.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
