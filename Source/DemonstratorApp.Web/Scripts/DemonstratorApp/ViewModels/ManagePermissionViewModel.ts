...
namespace DemonstratorApp.ViewModels.ManagePermission {
export class ManagePermissionViewModel extends DemonstratorApp.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
