...
namespace DemonstratorApp.ViewModels.ManageRole {
export class ManageRoleViewModel extends DemonstratorApp.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
