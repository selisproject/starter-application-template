...
namespace DemonstratorApp.ViewModels.ManageUser {
export class ManageUserViewModel extends DemonstratorApp.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
