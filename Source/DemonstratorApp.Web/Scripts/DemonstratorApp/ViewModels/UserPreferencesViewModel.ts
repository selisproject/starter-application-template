...
namespace DemonstratorApp.ViewModels.UserPreferences {
export class UserPreferencesViewModel extends DemonstratorApp.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
