...
using DemonstratorApp.UI.Controllers.ApplicationSettingsList;
using AppCode;
...
namespace DemonstratorApp.UI.ViewModels.ApplicationSettingsList
{
    ...
    [OriginalType(typeof(DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel))]
    public class ApplicationSettingsListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel>
    {

        [JsonConstructor]
        public ApplicationSettingsListViewModelDTO() { }
        public ApplicationSettingsListViewModelDTO(DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListSelectedItemKeys;

        public new DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel();
        }
        new  public DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DemonstratorApp.UI.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel original)
        {
            if (original == null) return;
