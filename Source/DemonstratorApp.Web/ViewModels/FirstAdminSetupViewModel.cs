...
using DemonstratorApp.UI.Controllers.FirstAdminSetup;
using AppCode;
...
namespace DemonstratorApp.UI.ViewModels.FirstAdminSetup
{
    ...
    [OriginalType(typeof(DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel))]
    public class FirstAdminSetupViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel>
    {

        [JsonConstructor]
        public FirstAdminSetupViewModelDTO() { }
        public FirstAdminSetupViewModelDTO(DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel).FullName;

        public new DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel();
        }
        new  public DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DemonstratorApp.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel original)
        {
            if (original == null) return;
