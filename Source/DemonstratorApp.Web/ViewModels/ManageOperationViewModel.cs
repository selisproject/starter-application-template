...
using DemonstratorApp.UI.Controllers.ManageOperation;
using AppCode;
...
namespace DemonstratorApp.UI.ViewModels.ManageOperation
{
    ...
    [OriginalType(typeof(DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel))]
    public class ManageOperationViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel>
    {

        [JsonConstructor]
        public ManageOperationViewModelDTO() { }
        public ManageOperationViewModelDTO(DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel();
        }
        new  public DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DemonstratorApp.UI.ViewModels.ManageOperation.ManageOperationViewModel original)
        {
            if (original == null) return;
