...
using DemonstratorApp.UI.Controllers.ManageUser;
using AppCode;
...
namespace DemonstratorApp.UI.ViewModels.ManageUser
{
    ...
    [OriginalType(typeof(DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel))]
    public class ManageUserViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel>
    {

        [JsonConstructor]
        public ManageUserViewModelDTO() { }
        public ManageUserViewModelDTO(DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button1SelectedItemKeys;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel();
        }
        new  public DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DemonstratorApp.UI.ViewModels.ManageUser.ManageUserViewModel original)
        {
            if (original == null) return;
