...
using DemonstratorApp.UI.Controllers.OperationsList;
using AppCode;
...
namespace DemonstratorApp.UI.ViewModels.OperationsList
{
    ...
    [OriginalType(typeof(DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel))]
    public class OperationsListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel>
    {

        [JsonConstructor]
        public OperationsListViewModelDTO() { }
        public OperationsListViewModelDTO(DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListSelectedItemKeys;

        public new DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel();
        }
        new  public DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DemonstratorApp.UI.ViewModels.OperationsList.OperationsListViewModel original)
        {
            if (original == null) return;
