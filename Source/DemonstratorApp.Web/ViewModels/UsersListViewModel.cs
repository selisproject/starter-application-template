...
using DemonstratorApp.UI.Controllers.UsersList;
using AppCode;
...
namespace DemonstratorApp.UI.ViewModels.UsersList
{
    ...
    [OriginalType(typeof(DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel))]
    public class UsersListViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel>
    {

        [JsonConstructor]
        public UsersListViewModelDTO() { }
        public UsersListViewModelDTO(DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel).FullName;
        public List<SelectedItemInfo<string>> ListSelectedItemKeys;

        public new DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel();
        }
        new  public DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DemonstratorApp.UI.ViewModels.UsersList.UsersListViewModel original)
        {
            if (original == null) return;
