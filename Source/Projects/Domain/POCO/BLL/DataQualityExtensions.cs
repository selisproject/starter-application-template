...
count = count.GetValueOrDefault(0) + 1;}
zAppDev.DotNet.Framework.Utilities.DebugHelper.Log(zAppDev.DotNet.Framework.Utilities.DebugMessageType.Warning, "DataQuality",  DemonstratorApp.Hubs.EventsHub.RaiseDebugMessage, "count " + (count?.ToString() ?? ""));
return count;
}
}
