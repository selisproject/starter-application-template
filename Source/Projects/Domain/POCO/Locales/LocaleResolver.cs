...
namespace DemonstratorApp.Locales
{
    ...
    public class LocaleResolver
    {
        ...
        private static string ReadEmbededResource(string fullPath)
        {
            ...
            var stream = typeof(DemonstratorApp.Locales.LocaleResolver).Assembly.GetManifestResourceStream(fullPath);
            if (stream == null)
            {
                stream = typeof(DemonstratorApp.Locales.LocaleResolver).Assembly.GetManifestResourceStream("Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DemonstratorApp.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DemonstratorApp."+ "Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DemonstratorApp.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DemonstratorApp."+ "Locales.Locales." + fullPath);
            }
            if(stream == null)
            {
                stream = typeof(DemonstratorApp.Locales.LocaleResolver).Assembly.GetManifestResourceStream("DemonstratorApp.Backend."+ "Locales.Locales." + fullPath);
            }
